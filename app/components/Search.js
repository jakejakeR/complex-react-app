        ...
        <>
            <div className="search-overlay-top shadow-sm">
                <div className="container container--narrow">
                    ...
                    <input onChange={handlInput} autoFocus type="text" autoComplete="off" id="live-search-field" className="live-search-field" placeholder="What are you interested in?" />
            ...
            <div className="search-overlay-bottom">
                <div className="container container--narrow py-3">
                    ...
                    <div className={"live-search-results" + (state.show == "results" ? "live-search-results--visible" : "")}>
                        ...
                        {!Boolean(state.results.length) && <p className="alert alert-danger text-center shadow-sm">Sorry, no results for that search.</p>}
                    </div>
                </div>
            </div>
        </>
